        ...
        {!registration ? (
          ...
          <div>
            ...
            <div className="mt-5 space-y-3 text-sm leading-6 text-content-secondary">
              ...
              <label className="flex items-start gap-3"><input type="checkbox" checked={acceptPrivacy} onChange={(event) => { setAcceptPrivacy(event.target.checked) }} className="mt-1 h-4 w-4 accent-brand-orange" /><span>I accept the privacy notice: my X handle is public; my confirmed email is encrypted and may be used for competition integrity, duplicate prevention, and competition-relevant messages; the private owner-wallet-to-Trading-Account link is protected and retained indefinitely for integrity and scoring audits.</span></label>
            </div>
            <div className="mt-5">
