    ...
    "outputs": [
      {
        "name": "result",
        "type": "tuple",
        "internalType": "struct CfdClosePreview.SponsoredClosePreview",
        "components": [
          {
            "name": "subsidyUsdc",
            "type": "uint256",
...
export const PERPS_CFD_CLOSE_PREVIEW_ABI = CFD_CLOSE_PREVIEW_ABI
