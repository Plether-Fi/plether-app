...
describe('Vaults page', () => {
  ...
  it('shows tranche-scoped holder distribution and requests on an individual vault page', () => {
    ...
    expect(within(section).getByText(/settled for that wallet and waiting to be claimed/i)).toBeInTheDocument()
    expect(within(section).getByText(/Deposits awaiting settlement are not included/i)).toBeInTheDocument()
