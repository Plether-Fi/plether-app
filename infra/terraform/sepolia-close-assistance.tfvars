...
# Initial rollout keeps assistance disabled. Enable only after operator canaries.
...
perps_close_assistance_enabled = false
perps_close_assistance_global_enabled = false
