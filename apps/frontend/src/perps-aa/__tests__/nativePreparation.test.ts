...
function fixture() {
  ...
  const op: ManagedUserOperation = { ...expected, nonce: 3n, signature: '0x', callGasLimit: 100000n,
    ...
    paymasterData: concatHex([numberToHex(now + 300n, { size: 6 }), numberToHex(now - 30n, { size: 6 }),
      numberToHex(350000000000n, { size: 16 }), PLETHER_PAYMASTER_POLICY_ID, PLETHER_SIMPLE_ACCOUNT_PROXY_CODE_HASH,
