...
function TileSkeleton() {
  return (
    <div className="bg-surface-panel p-5 border border-brand-border/50 h-full">
...
export function DashboardTile({
  ...
  return (
    <div
      className={`bg-surface-panel p-5 border ${styles.border} h-full transition-colors duration-200`}
    >
        <div className="flex items-center justify-between mb-2">
        ...
        <div className="space-y-3">
          <div className={`pb-3 border-b ${styles.divider}`}>
            <p className="text-2xl font-bold text-content-primary flex items-center gap-2">
          ...
          <div className="flex justify-between items-end">
            <div>
              <p className="text-xs text-content-secondary uppercase tracking-wider">{secondaryLabel}</p>
              <p className="text-lg font-semibold text-content-primary flex items-center gap-2">
            ...
            <div className="text-right">
              <p className="text-xs text-content-secondary uppercase tracking-wider">Current 7d APY</p>
