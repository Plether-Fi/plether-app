...
locals {
  # Approved reliability canary 205d747: API and bundled keeper only.
  ...
  aa_keeper_runtime_image           = local.frankfurt_preparation ? local.aa_api_runtime_image : local.api_image
