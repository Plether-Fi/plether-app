...
workerConfig mode =
  Config
    ...
    , cfgPerpsPublicLens = accountLens
    , cfgPerpsHousePool = housePool
    , cfgPerpsSeniorVault = seniorVault
    , cfgPerpsJuniorVault = juniorVault
    , cfgPerpsOrderRouterAdmin = router
    , cfgPerpsCfdEngineAdmin = engine
