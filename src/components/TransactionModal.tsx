...
export function TransactionModal() {
  ...
  return createPortal(
    <>
      ...
      <div
        className="fixed inset-0 top-[73px] z-40 bg-cyber-bg/60 backdrop-blur-sm"
        onClick={close}
      />

      {/* Modal - fixed to right side below header, aligned with header content */}
      <div className="fixed top-[73px] left-0 right-0 z-50 pointer-events-none animate-in fade-in slide-in-from-top-2 duration-200">
