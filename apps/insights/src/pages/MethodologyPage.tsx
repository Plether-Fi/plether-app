    ...
    <article className="mx-auto max-w-4xl">
      ...
      <Panel className="mt-8">
        ...
        <Rule number="02" title="Ranking metric">
          ...
          <p>Expand <strong>Trade breakdown</strong> to reconcile directional P&amp;L, assessed fees, VPI, carry, frozen-close spread, execution reward, and confirmed adjustments to the actual account change. Waived charges reduce costs; fees deducted from rebates reduce the amount paid to the trader. Subtotals are not additional gains.</p>
