    ...
    <article className="mx-auto max-w-4xl">
      ...
      <Panel className="mt-8">
        ...
        <Rule number="02" title="Ranking metric">
          ...
          <p>Use <strong>View breakdown</strong> on a close, or expand <strong>Trade breakdown</strong> on an open or increase, to reconcile directional P&amp;L, assessed fees, VPI, carry, frozen-close spread, execution reward, and confirmed adjustments to the actual account change. Breakdown amounts always show all six USDC decimals. Waived charges reduce costs; fees deducted from rebates reduce the amount paid to the trader. Subtotals are not additional gains.</p>
          <p>A close’s position breakdown includes its execution details and the position remaining immediately afterward. Each breakdown covers one execution; opening costs and earlier increases or partial closes remain on their own activity rows.</p>
