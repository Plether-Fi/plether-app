    ...
    <div className="max-w-3xl mx-auto space-y-8 text-sm text-content-secondary">
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          Service. If you do not agree, do not use the Interface.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          is one of many possible ways to interact with the protocol. We do not control the
          protocol itself, and transactions executed through smart contracts are irreversible.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          jurisdiction where the use of decentralized finance protocols is prohibited or
          restricted by law. You further represent that you are not subject to economic
          sanctions or listed on any prohibited party list.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          action. You are solely responsible for evaluating the risks and merits of using the
          protocol and for your own financial decisions.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          acknowledge that you may lose some or all of the digital assets you use in connection
          with the protocol, and you assume all risks associated with such use.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          REVENUE, DATA, OR DIGITAL ASSETS, WHETHER INCURRED DIRECTLY OR INDIRECTLY, ARISING
          FROM YOUR USE OF THE INTERFACE OR THE PROTOCOL.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          Interface or violation of these Terms.
        </p>
      </section>
